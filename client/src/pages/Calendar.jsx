        ...
        <div className="min-h-screen bg-gray-50 p-4 md:p-8 pb-24">
            <div className="max-w-6xl mx-auto">
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                    ...
                    <div className="flex items-center justify-between gap-4 bg-white p-2 rounded-xl shadow-sm border border-gray-100 w-full md:w-auto">
                        <button onClick={prevMonth} className="p-2 hover:bg-gray-100 rounded-lg transition-colors">
                            <ChevronLeft className="w-5 h-5 text-gray-600" />
                        </button>
                        <span className="text-lg font-semibold text-gray-900 flex-1 md:min-w-[150px] text-center">
